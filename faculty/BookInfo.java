...
public class BookInfo {
    public static void bookInfo(JFrame faculty) {
        ...
        returnBtn.addActionListener(ev -> {
            bookInfo.dispose(); // Close current window
            new FacultyBooks(); // Open FacultyBooks window
        });
        ...
        submitBtn.addActionListener(e -> {
            ...
            try {
                ...
                try (Connection con = DBConnection.connect()) {
                    // Insert the new book
                    String insertSql = "INSERT INTO book (book_title, publication_year, book_author, isbn_number, total_copies, available_copies, category) VALUES (?, ?, ?, ?, ?, ?, ?)";
